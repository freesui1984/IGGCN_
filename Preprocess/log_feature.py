...
"""
index_df = pd.read_csv("F:\\IGGCN\\data\\tusz_eeg\\4_class\\4_class_window_index.csv", dtype={"patient_ID": str})
...
# Save
np.save("F:\\IGGCN\\data\\tusz_eeg\\4_class\\feature_matrix.npy", log_amplitude_feature_matrix_scaled)
np.save("F:\\IGGCN\\data\\tusz_eeg\\4_class\\adjacency_feature_matrix.npy", adjacency_feature_matrix_scaled)
np.save("F:\\IGGCN\\data\\tusz_eeg\\4_class\\label_y.npy", index_df["label"].to_numpy())
